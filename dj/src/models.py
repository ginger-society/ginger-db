...
class enrollment(models.Model):
        ...
        student = models.ForeignKey('student',related_name = 'courses', on_delete=models.DO_NOTHING,          )
...
class course(models.Model):
        ...
        type = models.CharField( choices=course_type, max_length=50,   default='compulsary',      )
